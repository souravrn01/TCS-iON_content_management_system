...
const routes: Routes = [
  ...
  {path: 'post/:category', component:NewPostsComponent},
  {path: 'roothome', component: RootHomeComponent},
  {path: 'edit/:id/:category', component: EditComponentComponent},
  {path: 'userhome', component: UserHomeComponent},
  {path: 'managePosts', component:ManagePostsComponent, children:[{path: 'updatePosts/:category', component:UpdatePostsComponent}]},
